...
// RecursiveDeleteOption removed in Guava 33.x - using commons-io instead
...
public class FileUtils {
    ...
    public static Error deleteFile(String label, final String filePath, final boolean ignoreNonExistentFile, final boolean ignoreWrongFileType, int allowedFileTypeFlags) {
        ...
        try {
            ...
            // Using commons-io instead of Guava MoreFiles (removed in 33.x)
            if (fileType == FileType.DIRECTORY) {
                // deleteDirectory() gets the files list first instead of walking directory tree
    ...
    public static Error clearDirectory(String label, final String filePath) {
        ...
        try {
            ...
            if (fileType == FileType.DIRECTORY) {
                // Using commons-io cleanDirectory (Guava MoreFiles removed in 33.x)
