...
public abstract class UnixShellEnvironment implements IShellEnvironment {
     ...
     * NOTE: bash is prioritized over login script because login is a shell script that requires 
     * interpreter execution, which may be blocked by SELinux on enforcing devices. */
